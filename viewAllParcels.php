<div id="ordersBtn" >
 ...
 <!-- search function-->
  ...
  <a class="btn btn-primary openPopup" data-href="./adminView/viewReminder.php" href="javascript:void(0);">Reminder</a>
       ...
       <tr>
          ...
          <td><?=$row["receiveDate"]?></td>
           <?php 
            ...
            ?>
                <td><button class="btn btn-danger" onclick="ChangeParcelStatus('<?=$row['parcelID']?>')">Pending </button></td>
            <?php
                }else if($row["parcelStatus"]==1){//tukar
                            
              ?>
                  <td><button class="btn btn-success" onclick="ChangeParcelStatus('<?=$row['parcelID']?>')">Collected </button></td>
              <?php
                        
                }else{
            ?>
                <td><button class="btn btn-secondary" onclick="ChangeParcelStatus('<?=$row['parcelID']?>')">Disposed</button></td>
        <?php
                }
             ?> 
          <td><button class="btn btn-primary" style="height:40px" href="#Collection" onclick="showEachCollection2('<?=$row['parcelID']?>')">Details</button></td>
          <td><button class="btn btn-primary" style="height:40px" onclick="ParcelEditForm('<?=$row['parcelID']?>')">Edit</button></td>
          <td><button class="btn btn-danger" style="height:40px"  onclick="ParcelDelete('<?=$row['parcelID']?>')">Delete</button></td>
        </tr>
    <?php
